                ...
                <Modal title="Create New Invoice" onClose={() => setShowAdd(false)} wide>
                    ...
                    <FormActions>
                        <button
                            ...
                            className="border border-gray-200 text-gray-600 py-3 rounded-xl font-medium hover:bg-gray-50"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className="bg-green-500 hover:bg-green-600 text-white py-3 rounded-xl font-medium flex items-center justify-center gap-2"
                        >
                            <Check size={18} />
                            Create Invoice
                        </button>
